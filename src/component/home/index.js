...
export const HomePage = () => {
    ...
    return (
        <Grid item container >
            ...
            <Grid item container justifyContent={'space-between'} gap={'2rem'} padding={'3rem'} sx={{backgroundImage: 'linear-gradient(to left, #F8E5E5, #DAF5F8)'}}>
            {
                data?.map((i,index)=> (
                    <ItemCard src={i.src} desc={i.desc} price={i.price} title={i.title} key={index} />
                ))
            }
        </Grid>
        </Grid>
